...
const sortMeetingsByDay = (arr) => {
  // Solution code here...
  let weekDayNum = ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday'];
  return arr.sort(function (a, b) {
    ...
    a = weekDayNumberConversion(a.dayOfWeek);
    b = weekDayNumberConversion(b.dayOfWeek);
